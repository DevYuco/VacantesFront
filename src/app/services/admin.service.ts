...
export class AdminService {
	...
	private baseUrl: string = "https://apireto.matabuena.com/api/admin";
	constructor() {}
	...
	modificarEmpresa(idEmpresa: string, data: IEmpresaModificar): Observable<IEmpresaModificar> {
		return this.httpCliente.put<IEmpresaModificar>(`${this.baseUrl}/modificarEmpresa/${idEmpresa}`, data);
	}
	...
	modificarUsuario(email: string, data: IUser): Observable<IUser> {
		return this.httpCliente.put<IUser>(`${this.baseUrl}/modificarUsuario/${email}`, data);
	}
	...
	modificarCategoria(idCategoria: string, data: ICategoria): Observable<ICategoria> {
		return this.httpCliente.put<ICategoria>(`${this.baseUrl}/modificarCategoria/${idCategoria}`, data);
	}
